...
post_correction(){
	...
	--mode "nrandom" --prob-type "Gaussian" --max-check-pair-percentage 0.3 --nbest 5 --cluster-samples 20 exp/clustering_ivector_constraint/$eval_data/segments exp/ref/$eval_data/segments exp/extractor_256 data/$eval_data exp/clustering_ivector_post_correction/$eval_data	
