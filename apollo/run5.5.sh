...
dev_data="apollo_all"  # dev_data is for UBM, TV matrix training for i-vector
...
compute_der(){
    ...
    diar/compute_DER.sh --sanity_check false --column-forgive 1 data/$eval_data exp/clustering_ivector/$eval_data/rttms exp/result_DER/$eval_data	
