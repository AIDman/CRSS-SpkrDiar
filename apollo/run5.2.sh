...
vad_segmentation(){
   ...
   diar/train_vad_gmm.sh --nj 1 data/$eval_data exp/vad_segmentation/$eval_data
   diar/convert_ali_to_vad.sh --nj 1 data/$eval_data exp/vad_segmentation/$eval_data/lang exp/vad_segmentation/$eval_data    
   mkdir -p exp/vad_segmentation/$eval_data/segments
...
bottom_up_clustering(){
    ...
    diar/segment_clustering_ivector.sh --nj 1 --apply-cmvn-utterance false --apply-cmvn-sliding false \
       --ivector-dist-stop 0.7 exp/audioseg/$eval_data/segments exp/extractor_256 data/$eval_data exp/clustering_ivector/$eval_data
