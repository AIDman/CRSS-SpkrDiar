...
bottom_up_clustering(){
    log_start "Bottom Up Clustering With Ivector Trained With SRE Data"

    diar/segment_clustering_ivector.sh --nj 1 --apply-cmvn-utterance false --apply-cmvn-sliding true \
       --ivector-dist-stop 0.7 exp/ref/$eval_data/segments exp/extractor_1024 data/$eval_data exp/clustering_ivector/$eval_data

    log_end "Bottom Up Clustering With Ivector Trained With SRE Data"
}
bottom_up_clustering
