...
bottom_up_clustering(){
	...
	--do-consolidate true --max-consolidate-pair-percentage 0.3 --ivector-dist-stop 5.7 exp/ref/$eval_data/segments exp/extractor_256 data/$eval_data exp/clustering_ivector_constraint/$eval_data
