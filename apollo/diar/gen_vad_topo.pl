...
( $num_nonsil_states >= 1 && $num_nonsil_states <= 300 ) || die "Unexpected number of nonsilence-model states $num_nonsil_states\n";
( $num_sil_states >= 1 && $num_sil_states <= 300 ) || die "Unexpected number of silence-model states $num_sil_states\n";
