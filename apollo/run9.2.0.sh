...
bottom_up_clustering(){
    ...
    diar/segment_clustering_ivector_constraint.sh --nj 1 --apply-cmvn-utterance false --apply-cmvn-sliding false \
       --explore-mode "Random" --max-explore-pair-percentage 0.2 --merge-constraint true \
	--do-consolidate true --max-consolidate-pair-percentage 0.3 --ivector-dist-stop 5.7 \
