...
bottom_up_clustering(){
    ...
    diar/segment_clustering.sh --nj 1 --lambda 1 exp/ref/$eval_data/segments data/$eval_data exp/clustering/$eval_data	
    diar/segment_clustering_ivector.sh --nj 1 --use-segment-label true --ivector-dist-stop 0.7 exp/clustering/$eval_data/segments exp/extractor_256 data/$eval_data exp/clustering_ivector/$eval_data	
